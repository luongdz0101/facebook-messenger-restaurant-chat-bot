...
let handlePostback = async (sender_psid, received_postback) => {
    ...
    switch (payload) {
        ...
        case "SHOW_ROOM_DETAIL":
            ...
            break;
        case "SHOW_ROOM_DETAIL_1":
            await chatBotService.showRoomDetail_1(sender_psid);
            break;
        case "SHOW_ROOM_DETAIL_2":
            await chatBotService.showRoomDetail_2(sender_psid);
            break;
        case "SHOW_ROOM_DETAIL_3":
            await chatBotService.showRoomDetail_3(sender_psid);
            break;
        case "SHOW_ROOM_DETAIL_4":
            await chatBotService.showRoomDetail_4(sender_psid);
            break;
        case "SHOW_ROOM_DETAIL_5":
            await chatBotService.showRoomDetail_5(sender_psid);
            break;
        ...
        case "REPLY":
            //send main menu to users
            await chatBotService.sendReply(sender_psid);
            break;
        case "REPLY_1":
            //send main menu to users
            await chatBotService.sendReply_1(sender_psid);
            break;
        case "REPLY_2":
            //send main menu to users
            await chatBotService.sendReply_2(sender_psid);
            break;
        case "REPLY_3":
            //send main menu to users
            await chatBotService.sendReply_3(sender_psid);
            break;
        case "REPLY_4":
            //send main menu to users
            await chatBotService.sendReply_4(sender_psid);
            break;
        case "REPLY_5":
            //send main menu to users
            await chatBotService.sendReply_5(sender_psid);
            break;
        case "REPLY_6":
            //send main menu to users
            await chatBotService.sendReply_6(sender_psid);
            break;
        case "yes":
